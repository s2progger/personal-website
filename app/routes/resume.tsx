              ...
              <section className="break-inside-avoid">
                ...
                <div>
                  <ul className="-ml-0.5 flex flex-wrap text-sm leading-relaxed">
                    <li className="print:prnt-box m-0.5 bg-skill px-2 text-secondary hover:bg-indigo-100">Rust</li>
              ...
              <section className="mt-8 break-inside-avoid">
                <header>
                  <div className="mb-2 flex justify-between align-baseline">
                    ...
                    <span className="date-range text-sm text-space-cadet-250">June 2023 - March 2024</span>
                  </div>
                </header>
                <div>
                  <ul className="-ml-0.5 flex flex-wrap text-sm leading-relaxed">
